...
export function AddFriendCard() {
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-sm overflow-hidden">
      ...
      >
        <div className="shrink-0 w-7 h-7 flex items-center justify-center rounded-lg bg-amber-100 dark:bg-amber-900/30 text-amber-600 dark:text-amber-400">
        ...
        <span className="flex-1 text-sm font-medium text-gray-700 dark:text-gray-300">Add a friend</span>
        {requests.length > 0 && (
        ...
        <svg
          className={`shrink-0 w-4 h-4 text-gray-400 transition-transform duration-200 ${isExpanded ? 'rotate-180' : ''}`}
          viewBox="0 0 20 20"
          fill="currentColor"
        >
