...
async def send_turn_notification(user_id: str, game_id: str) -> None:
    """Notify user_id that it is their turn in game_id. Fire-and-forget; never raises."""
...
async def send_challenge_notification(user_id: str, game_id: str, challenger_name: str) -> None:
    """Notify user_id they have been challenged by challenger_name. Fire-and-forget; never raises."""
    if not VAPID_PRIVATE_KEY:
        return
    try:
        db = get_db()
